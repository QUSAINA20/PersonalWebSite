                                ...
                                <table class="table table-striped table-bordered table-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('experience.restore', $experience) }}" class="btn btn-success me-2">Restore</a>
                                                    <a href="{{route('experience.forceDelete' , $experience->id) }}" class="btn btn-primary" onclick="return confirm('Are you sure you want to delete this experience Parmanetly?')">Delete</a>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
