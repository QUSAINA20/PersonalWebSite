<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="{{ $portfolio->name }} Portfolio"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-end">
                                    <a href="{{ route('portfolio.edit', $portfolio) }}" class="btn btn-primary me-2">Edit</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                                        <a href="{{ $portfolio->link }}" class="d-block blur-shadow-image">
                                                            <img src="{{ $portfolio->getFirstMedia('images')->getUrl() }}" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg" />
                                                        </a>
                                                        <div class="colored-shadow" style="background-image: url('{{ $portfolio->getFirstMedia('images')->getUrl() }}');">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body px-4 pt-2">
                                                        ...
                                                        <a target=".blank" href="{{ $portfolio->link }}" class="btn bg-gradient-primary mt-3 mb-0">Read more</a>
                                                    </div>
                                                </tbody>
                                            </div>
                                        </div>
